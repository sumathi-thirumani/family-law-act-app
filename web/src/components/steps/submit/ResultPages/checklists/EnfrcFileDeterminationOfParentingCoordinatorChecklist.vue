        ...
        <div>
            <div style="margin:0rem 0 0rem 0; display:inline;">
                <check-box 
                    ...
                    check="'yes'" 
                    text="Step 1: Complete the Request to File a Determination of Parenting Coordinator form"/>               
            </div>   
        ...
        <div>
            <div style="margin:0rem 0 0 0; display:inline;">
                <check-box 
                    ...
                    check="'yes'" 
                    text="Step 2: File the Request to File a Determination of Parenting Coordinator and determination at the Provincial Court Registry"/>               
            </div>  
...
export default class EnfrcFileDeterminationOfParentingCoordinatorChecklist extends Vue {
