        ...
        <div>
            <div style="margin:0rem 0 0rem 0; display:inline;">
                <check-box 
                    ...
                    check="'yes'" 
                    text="Step 1: Complete the Request to File an Order form"/>               
            </div>   
        ...
        <div>
            <div style="margin:0rem 0 0 0; display:inline;">
                <check-box 
                    ...
                    check="'yes'" 
                    text="Step 2: File the Request to File an Order form and certified copy of the order at the Provincial Court Registry"/>               
            </div>  
...
export default class EnfrcFileOrderChecklist extends Vue {
