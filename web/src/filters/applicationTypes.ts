export const FLA_Types = [
    ...
    {pathway:"electronicFilingStatementFs",                 pdfType:"EFSPFS",  appType:"EFSPFS",     familyType:"EFSP",   otherForms:true, fullName:"Electronic Filing Statement - Financial Statement"},
